        ...
        <div class="col-lg-8 pl-lg-0">
            ...
            <div class="gallery">
                ...
                <img
                    ...
                    xoriginal="{{url('frontend/images/1.jpg')}}"
                />
                <div class="xzoom-thumbs">
                    <a href="{{url('frontend/images/1.jpg')}}"
                    ><img
                        class="xzoom-gallery"
                        width="128"
                        src="{{url('frontend/images/1.jpg')}}"
                        xpreview="{{url('frontend/images/1.jpg')}}"
                    /></a>
                    <a href="{{url('frontend/images/2.1.jpg')}}"
                    ><img
                        class="xzoom-gallery"
                        width="128"
                        src="{{url('frontend/images/2.1.jpg')}}"
                        xpreview="{{url('frontend/images/1.jpg')}}"
                    /></a>
                    <a href="{{url('frontend/images/3.jpg')}}"
                    ><img
                        class="xzoom-gallery"
                        width="128"
                        src="{{url('frontend/images/3.jpg')}}"
                        xpreview="{{url('frontend/images/3.jpg')}}"
                    /></a>
                    <a href="{{url('frontend/images/4.jpg')}}"
                    ><img
                        class="xzoom-gallery"
                        width="128"
                        src="{{url('frontend/images/4.jpg')}}"
                        xpreview="{{url('frontend/images/4.jpg')}}"
                    /></a>
                    <a href="{{url('frontend/images/5.jpg')}}"
                    ><img
                        class="xzoom-gallery"
                        width="128"
                        src="{{url('frontend/images/5.jpg')}}"
                        xpreview="{{url('frontend/images/5.jpg')}}"
                    /></a>
                </div>
                </div>
