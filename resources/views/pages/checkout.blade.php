    ...
    <div class="col-lg-8 pl-lg-0">
        ...
        <div class="attendee">
            ...
            <tbody>
                ...
                <td>
                    <img
                    src="{{url('frontend/images/user_pic.png')}}"
                    alt=""
                    height="60"
                    />
                </td>
                <td class="align-middle">Bambang Solehudin</td>
                ...
                <td>
                    <img
                    src="{{url('frontend/images/user_pic_2.png')}}"
                    alt=""
                    height="60"
                    />
                </td>
                <td class="align-middle">Cindy Yuvia</td>
